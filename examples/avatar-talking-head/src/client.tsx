...
function App() {
  ...
  const [playbackStream, setPlaybackStream] = useState<MediaStream | null>(
    null
  );
  const audioInput = useMemo(
    () =>
      new SFUVoiceAudioInput({
        ...
        // Matches HeadAudio's viseme classification lag so the mouth tracks
        // the voice instead of trailing it.
        playbackDelayMs: 100,
